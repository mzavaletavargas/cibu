...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CIBU VII" },
      { name: "description", content: "CIBU Futures is a landing page for the VIII International Congress of University Libraries." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "CIBU VII" },
      { property: "og:description", content: "CIBU Futures is a landing page for the VIII International Congress of University Libraries." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "CIBU VII" },

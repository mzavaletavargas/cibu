...
const expositores: Expositor[] = [
  ...
  {
    name: "Eduardo Alfaro",
    institution: "Maskhay Corp",
    country: "Perú",
    photo: "https://res.cloudinary.com/dtioir2dl/image/upload/v1782149275/Screenshot_From_2026-06-22_13-27-30_fxt86l.png",
    bio: [
      "CEO de MASKHAY CORP, una empresa comprometida con la innovación y el desarrollo de soluciones para el acceso a información científica con fines académicos y de investigación.",
      "Profesional con experiencia en implementación de la estrategia corporativa, la toma de decisiones de alto impacto y el desarrollo de oportunidades de negocio. Cuenta con una Maestría en Manejo y Conservación de Recursos Naturales y Biodiversidad en la CATIE de Costa Rica; en Finanzas e Inversiones Internacionales en la Universidad San Martín de Porres; y en Educación Superior e Investigación en la Universidad Científica del Sur.",
      "Su formación académica y experiencia laboral le han permitido desarrollar habilidades para desempeñarse de manera eficiente, ética y responsable, aportando valor a las organizaciones en las que ha colaborado. Antes de asumir la máxima dirección de MASKHAY CORP, acumuló 15 años de experiencia como Gerente Regional de EBSCO Information Services.",
      "A lo largo de su trayectoria profesional, ha enfocado su trabajo en liderar equipos de alto desempeño, impulsar procesos y orientar a la toma de decisiones que contribuyan al crecimiento y fortalecimiento institucional.",
    ],
  },
  {
    name: "Julio Santillán",
    institution: "Comciencia Perú · Open Access Perú",
    country: "Perú",
    photo: "https://res.cloudinary.com/dtioir2dl/image/upload/v1782149349/Screenshot_From_2026-06-22_13-29-00_y01blm.png",
    bio: [
      "Bibliotecólogo, doctor y magíster en Ciencias de la Información por la Universidade de Brasília (Brasil), con licenciatura en Bibliotecología y Ciencias de la Información por la Universidad Nacional Mayor de San Marcos (Perú).",
      "Cuenta con amplia experiencia en asesoría en gestión del conocimiento, sistemas de información académica y comunicación científica. Ha desempeñado funciones relevantes en instituciones públicas y privadas, entre las que destacan los cargos de Director de Investigación en la Universidad Tecnológica del Perú, Gestor de Conocimiento Científico en el Ministerio de Educación del Perú y Jefe del Centro de Documentación del Instituto Bartolomé de Las Casas.",
      "Actualmente se desempeña como Gerente General de Comciencia Perú, empresa consultora especializada en comunicación científica y publicaciones académicas.",
    ],
  },
  {
    name: "Karina Vargas García",
    institution: "Universidad Castro Carazo",
    country: "Costa Rica",
    photo: "https://res.cloudinary.com/dtioir2dl/image/upload/v1782149504/Screenshot_From_2026-06-22_13-30-14_dgbi2l.png",
    bio: [
      "Bachiller en Bibliotecología con énfasis en Tecnologías de la Información y Bachiller en Ingeniería en Sistemas. Su trabajo se orienta a la transformación digital de bibliotecas y organizaciones mediante la integración de tecnologías emergentes, análisis de datos e inteligencia artificial.",
      "Interesada en el desarrollo de competencias informacionales y digitales, así como en la aplicación ética de la tecnología para fortalecer la gestión de la información y la toma de decisiones. Actualmente se desempeña como Bibliotecóloga de la Sede San José, en la Biblioteca de la Universidad Castro Carazo.",
    ],
  },
  {
    ...
    institution: "Universidad Castro Carazo",
    country: "Costa Rica",
    photo: "https://res.cloudinary.com/dtioir2dl/image/upload/v1782149484/Screenshot_From_2026-06-22_13-30-23_ixpzgi.png",
    bio: [
      "Licenciada en Bibliotecología, Bibliotecas Educativas y Centros de Recursos para el Aprendizaje, con experiencia en el diseño de experiencias de aprendizaje y el fortalecimiento de competencias informacionales, digitales y mediáticas.",
      "Su trabajo se enfoca en la incorporación estratégica de tecnologías emergentes, recursos académicos digitales e inteligencia artificial para apoyar los procesos de enseñanza, aprendizaje e investigación. Actualmente se desempeña como Bibliotecóloga de la Sede Regional, Pérez Zeledón, en la Biblioteca de la Universidad Castro Carazo.",
    ],
  },
  {
    ...
    bio: [
      "Máster en Currículum y Docencia Universitaria y profesional en Bibliotecología, con experiencia en el diseño de experiencias de aprendizaje y el desarrollo de competencias informacionales y digitales.",
      "Integró tecnologías emergentes, inteligencia artificial y recursos académicos digitales para promover el pensamiento crítico, el uso ético de la información y el aprendizaje continuo. Actualmente se desempeña como Directora de Biblioteca de la Universidad Castro Carazo.",
    ],
  },
  {
    ...
    bio: [
      ...
      "Creador del marco PAPAYAS para la alfabetización crítica en IA y del AI Access & Dignity Canvas, herramientas que ayudan a llevar la inteligencia artificial a las bibliotecas con criterio, equidad y mirada del Sur Global. Su trabajo une la innovación tecnológica con un humanismo bibliotecario centrado en la dignidad del acceso al conocimiento.",
    ],
  },
  {
    name: "Henry Chávez",
    institution: "Colegio de Bibliotecólogos del Perú",
    country: "Perú",
    photo: "https://res.cloudinary.com/dtioir2dl/image/upload/v1782149482/Screenshot_From_2026-06-22_13-31-09_tmaqsb.png",
    bio: [

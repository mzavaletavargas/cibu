...
const LOGO_URL =
  "https://res.cloudinary.com/dtioir2dl/image/upload/f_auto,q_auto,w_160,dpr_auto/v1778733901/cibu-logo_dfkk9f.png";
      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid md:grid-cols-3 gap-10">
        <div>
          ...
          <p className="text-sm opacity-80 leading-relaxed">
            Congreso Internacional de Bibliotecas Universitarias. Bibliotecas e IA: construyendo
            futuros posibles.
          </p>
        </div>
        <div className="space-y-2 text-sm opacity-90">
          <div className="flex items-start gap-2">
            ...
            <span>Universidad Privada Antenor Orrego, Av. América Sur 3145, Trujillo 13008</span>
          </div>
          ...
          <div className="pt-2 border-t border-white/10 mt-2 space-y-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="tel:+51945496456" className="hover:text-[var(--gold)] transition">
                945 496 456
              </a>
            </div>
            <div className="flex items-center gap-2">
              <Phone className="w-4 h-4" />{" "}
              <a href="tel:+51986160732" className="hover:text-[var(--gold)] transition">
                986 160 732
              </a>
            </div>
          </div>
          <div className="pt-2 border-t border-white/10 mt-2 space-y-1">
            ...
            <div className="flex items-center gap-2">
              <Phone className="w-4 h-4" />{" "}
              <a href="tel:968709488" className="hover:text-[var(--gold)] transition">
                968 709 488
              </a>{" "}
              — Lucca Ravest Castillo
            </div>
            <div className="flex items-center gap-2">
              <Phone className="w-4 h-4" />{" "}
              <a href="tel:+51945496456" className="hover:text-[var(--gold)] transition">
